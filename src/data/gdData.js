export const floors = {
  ...
  'floor1': {
    ...
    'encounters': {
      '01': {
        'description': 'Forgotten Android(s)',
        'reference': 'pg. 11' ,
        'count': '1d5',
        'tags': 'forgotten'
      },
  ...
  'floor3.5': {
    ...
    'encounters': {
      ...
      '07': {
        'description': 'Security Android(s) chasing escapees',
        'reference':'pg. 10',
        'count': '1d10',
        'tags': ''
      },
  ...
  'floor3.7': {
    ...
    'encounters': {
      ...
      '07': {
        'description': 'Infiltrator Android of NPC the crew already met',
        'reference': 'pg. 10',
        'count': 0 ,
        'tags': ''
      },
  ...
  'floor4': {
    ...
    'encounters': {
      '01': {
        'description': 'Escaped Child Android(s)' ,
        'reference': 'pg. 54',
        'count': '1d10',
        'tags': 'child'
      },
